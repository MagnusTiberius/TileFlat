...
namespace VehicleLib
{
    ...
    public class PackageList
    {
        ...
        public PackageList()
        {
            ...
            // Mitsubishi
            //
            list.Add(new Package { Guid = new Guid("34CA759A-9850-4D53-9F47-6C3A285D6D0E"), Code = "Warranty", Name = "Warranty", Price = 0, FeatureList = new string[] { "5-year/ 60,000-mile Powertrain Limited Warranty" } });
            ...
            list.Add(new Package { Guid = new Guid("BE3B97EE-678E-41D3-B388-EF90F2D0B37F"), Code = "RearParkAssistSensors", Name = "Rear Park Assist Package", Price = 295, FeatureList = new string[] { "Rear park assist." } });
            ...
            list.Add(new Package { Guid = new Guid("F9FC34CE-FC45-47B2-AFF1-B5D43DD1175A"), Code = "Engine300hp3literDOHC24valveV6", Name = "300-hp 3.5-liter DOHC 24-valve V6 engine", Price = 0, FeatureList = new string[] { } });
            list.Add(new Package { Guid = new Guid("1943C20F-6C63-4F51-BF1A-8569A203D50D"), Code = "DriveModeSelector", Name = "Drive Mode Selector (Sport and Manual Modes)", Price = 0, FeatureList = new string[] { } });
            list.Add(new Package { Guid = new Guid("A03D53D4-DC32-44D3-843B-F26597D499A5"), Code = "NissanConnectSM", Name = "NissanConnectSM Services Powered by SiriusXM®", Price = 0, FeatureList = new string[] { } });
            list.Add(new Package { Guid = new Guid("6BC37803-2195-43D5-B710-16DC359EBD65"), Code = "AscotLeatherSeat", Name = "Premium Ascot Leather-appointed Seats with Diamond-Quilted Inserts", Price = 0, FeatureList = new string[] { } });
            list.Add(new Package { Guid = new Guid("47B4F19A-CAC0-4895-B42C-629A82444EC1"), Code = "AscotLeatherSteering", Name = "Premium Ascot Leather-Wrapped Steering Wheel", Price = 0, FeatureList = new string[] { } });
            list.Add(new Package { Guid = new Guid("26937A1C-5C1D-463D-806C-D7E11E136870"), Code = "OutsideMirrosWithReverseTilt", Name = "Outside mirrors with Reverse Tilt-Down feature", Price = 0, FeatureList = new string[] { } });
            list.Add(new Package { Guid = new Guid("2ED8E1C7-4662-4C69-AE03-6B49C30FE084"), Code = "RainSensingWipers", Name = "Rain Sensing Wipers", Price = 0, FeatureList = new string[] { } });
            list.Add(new Package { Guid = new Guid("58AB4232-D2B7-4D0F-9FEB-3E620AE71569"), Code = "PowerHeatedOutsideMirrorsWithLED", Name = "Power Heated Outside Mirrors with LED Turn Signal Indicators", Price = 0, FeatureList = new string[] { "Maxima's power heated dual outside mirrors are equipped with integrated LED turn signals that provide extra visibility to surrounding vehicles and pedestrians." } });
            list.Add(new Package { Guid = new Guid("21D8D3E6-6400-4645-88A7-33D82E9E2D6D"), Code = "DAA", Name = "Driver Attention Alert (DAA)", Price = 0, FeatureList = new string[] { } });
            list.Add(new Package { Guid = new Guid("6107C3DA-9722-497D-A66B-79F809EAACAB"), Code = "AroundViewMonitor", Name = "Around View® Monitor with Moving Object Detection", Price = 0, FeatureList = new string[] { } });
            list.Add(new Package { Guid = new Guid("3EF4D07B-51AB-4D6D-BFD9-0ACA792F320B"), Code = "BSW", Name = "Blind Spot Warning (BSW)", Price = 0, FeatureList = new string[] { "If Maxima's BSW system detects a vehicle in the blind spot area indicators on both the Advanced Drive-Assist® Display and driver's or front passenger's front door will illuminate to let you know it's there. If you signal while the vehicle is still in the blind spot area, an audible alert and warning light will help alert you." } });

            list.Add(new Package { Guid = new Guid("00E32C9A-CE72-4F96-AFC5-6F4A151450CD"), Code = "PaddleShifters", Name = "Paddle Shifters", Price = 0, FeatureList = new string[] { "Paddle shifters allow you manual control at your fingertips." } });
            list.Add(new Package { Guid = new Guid("D04EA7E6-1F14-4166-A05F-F88E93236841"), Code = "MachineFinishedAllowWheels", Name = "19\" \"Diamond-cut\" Machine-finished Aluminum-alloy Wheels", Price = 0, FeatureList = new string[] { "Maxima SR features a set of 19 inch \"diamond-cut\" aluminum-alloy wheels with a machine finish and are fitted with P245/45VR19 tires for optimal handling and traction." } });
            list.Add(new Package { Guid = new Guid("384F273B-F1F2-4472-9708-BE1C32BD9C8B"), Code = "SignatureLEDlights", Name = "Signature LED Head Lights", Price = 0, FeatureList = new string[] { "Up front, the boomerang-shaped headlights feature a captivating LED signature line that stays illuminated at all times. In back, LEDs also accent the wraparound taillights, and “4DSC” is embossed in the lamp housings, front and rear—a subtle reminder of what the all-new Maxima is all about." } });
            list.Add(new Package { Guid = new Guid("8519C677-812A-499A-B1E9-7689204CF89F"), Code = "RCTA", Name = "Rear Cross Traffic Alert (RCTA)", Price = 0, FeatureList = new string[] { "When you are in reverse, RCTA helps detect vehicles approaching from either side. If an approaching vehicle is detected, the system provides visual and audio warnings" } });
            list.Add(new Package { Guid = new Guid("04653F94-E89C-4E9A-894D-3F097BE26019"), Code = "PFCW", Name = "Predictive Forward Collision Warning (PFCW) with Forward Emergency Braking (FEB)", Price = 0, FeatureList = new string[] { "Predictive Forward Collision Warning can alert you to potential risks up ahead by not only monitoring the velocity and distance of the vehicle in front of you, but the vehicle in front of that one as well. Although obscured from your forward field-of-view, sensors can detect if that vehicle suddenly and unexpectedly slows, giving you time to react to the situation. If Maxima detects that you need to slow down to avoid a frontal collision, the FEB system will alert you with visual and audible cues and, if necessary, assist you by automatically applying pressure to the brakes to help avoid or mitigate a collision." } });

            list.Add(new Package { Guid = new Guid("971A0015-87A3-40A5-98A5-559178E941A1"), Code = "Wheels18inch", Name = "18” aluminum-alloy wheels", Price = 0, FeatureList = new string[] { "Maxima performs on a set of 18” aluminum-alloy wheels with a machine-finish and are fitted with P245/45VR18 tires for optimal handling and traction." } });
            list.Add(new Package { Guid = new Guid("3774A053-8665-4507-83F0-B4D506E32076"), Code = "DualPanelMoonroof", Name = "Dual Panel Panoramic Moonroof", Price = 0, FeatureList = new string[] { "The panoramic moonroof is simply massive. So big that it reaches over the back seats, allowing co-pilots and navigators alike to enjoy the feeling of an open atmosphere and an unfettered view of the sky above" } });
            list.Add(new Package { Guid = new Guid("5A9D1C96-A735-4E8E-8B92-620096FFCCE7"), Code = "BosePremiumAudio", Name = "Bose® Premium Audio System", Price = 0, FeatureList = new string[] { "The 11-speaker Bose® audio system features eleven optimally placed speakers including a center channel speaker. Additionally, it features center point technology that delivers rich sound to the driver and occupants in the front and back seats. [*]" } });
            list.Add(new Package { Guid = new Guid("B0908E12-459C-45F0-B573-06E12A0FED00"), Code = "IntelligentCruiseControl", Name = "Intelligent Cruise Control (ICC)", Price = 0, FeatureList = new string[] { "Intelligent Cruise Control uses radar to maintain a set distance between you and the car in front of you, even braking to maintain that distance or bring you to a complete stop if necessary. [*]" } });

            list.Add(new Package { Guid = new Guid("D7BDF3BE-6D1F-4906-992E-55E12AD1759C"), Code = "LeatherAppointedSeats", Name = "Leather-appointed seats", Price = 0, FeatureList = new string[] { "This spacious 5-seater offers everyone comfort with refinement. Designed with special attention to detail, each leather seat is deeply bolstered and double-stitched." } });
            list.Add(new Package { Guid = new Guid("DCE6D88A-3014-47FD-BB75-DA506B21974D"), Code = "HeatedFrontSeats", Name = "Heated Front Seats", Price = 0, FeatureList = new string[] { "Heated front seats and other unexpected upscale touches offer you and your passengers ultimate comfort and style." } });
            list.Add(new Package { Guid = new Guid("49E86592-E6DD-4761-9D1E-DB2ACC37B584"), Code = "DriveSeatLumbarSupport", Name = "Driver's Seat Power Lumbar Support", Price = 0, FeatureList = new string[] { "With this available feature, you can inflate or deflate the lower portion of the driver’s seatback for a personalized, supportive fit and a more comfortable ride." } });
            list.Add(new Package { Guid = new Guid("7103C409-1D0F-4777-8E3F-2BDA25D780C6"), Code = "SonarSystemFrontRear", Name = "Front and Rear Sonar System", Price = 0, FeatureList = new string[] { "Maxima®’s parking sonar gives you an added ally in your pursuit of parking, with sensors on all four corners looking out for static objects and giving you an audible warning when you’re getting close." } });
            list.Add(new Package { Guid = new Guid("2F252749-3C85-4B23-807A-82470EF02F0F"), Code = "NissanAdvancedAirBag", Name = "Nissan Advanced Air Bag System", Price = 0, FeatureList = new string[] { "Nissan Advanced Air Bag System has front air bags with seat belt and occupant-classification sensors. In addition, Maxima features front seat-mounted side-impact supplemental air bags, and roof-mounted curtain side-impact supplemental air bags with rollover sensors. [*]" } });
            list.Add(new Package { Guid = new Guid("CC8CA107-B9F2-4FA6-98DA-B87858399148"), Code = "VDCTCS", Name = "Vehicle Dynamic Control (VDC) with Traction Control System (TCS)", Price = 0, FeatureList = new string[] { "Whether you need to hit the brakes hard or maneuver around an unexpected obstacle, these standard technologies help you respond to a potentially harmful situation. VDC helps you maintain your steered path. TCS helps reduce wheelspin in low traction situations." } });

            list.Add(new Package { Guid = new Guid("DDAEE389-FAFF-490F-B041-21E3F5A540EA"), Code = "DriveAssistDisplay", Name = "7.0\" Color Advanced Drive Assist® Display", Price = 0, FeatureList = new string[] { "The 7\" display keeps key information as close as a glance so you can access the tech you need at every turn. From available turn-by-turn directions to caller ID or safety features, the Advanced Drive-Assist® Display lays it all right before your eyes - helping to minimize time looking away." } });
            list.Add(new Package { Guid = new Guid("56CB2750-23C9-440D-A93C-BCADAC45EEE6"), Code = "RearviewMonitor", Name = "RearView Monitor", Price = 0, FeatureList = new string[] { "Backing up made easy, with the Maxima's RearView Monitor. A discreet color camera mounted on the rear of the vehicle helps you see what's directly behind you, using the screen in front of you. [*]" } });
            list.Add(new Package { Guid = new Guid("A97B39FB-DB4B-481F-905E-0096D01E9DA1"), Code = "TaillightLEDsignature", Name = "Taillights with integrated LED signature", Price = 0, FeatureList = new string[] { "Taillights with integrated LED signature – a wraparound boomerang LED signature in the taillights gives Maxima another touch of signature style at night." } });
            list.Add(new Package { Guid = new Guid("D721780A-45D3-4E3A-89B7-15D5E34C9DCE"), Code = "TPMS", Name = "Tire Pressure Monitoring System with Easy-Fill Tire Alert", Price = 0, FeatureList = new string[] { "TPMS lets you know when a tire is low. And Easy-Fill Tire Alert takes the guesswork out of filling your tires, with a beep of the horn when you’ve reached the correct pressure." } });
